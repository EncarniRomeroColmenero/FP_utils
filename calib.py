...
def calibrate(l, r, z):
    """
    function to take lambda, r, and Z data, fit calib_func to them, and return/plot the results
    ...
    fit = opt.fmin_powell(calib_func, init, args=((r, z), l), ftol=0.00001)
...
if __name__ == '__main__':
	...
	for i in list:
	    ...
	    prof, r = ring.FP_profile(fp_im, xc, yc, trim_rad=trim_rad, mask=mask_val)
		...
		out.write("%s %s %s %s %f %s\n" % (dateobs, time, lamp, line, cen_peak, z))
