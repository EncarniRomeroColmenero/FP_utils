...
def find_center(im, xc, yc, cutsize=5, tolerance=25):
    """
    here we find peaks in the 4 cardinal directions, centroid the
    brightest one, and use the results to fit for the ring center.
    use image slices since median filtering doesn't appear
    ...
    xdown = im[yc - cutsize:yc + cutsize, 0:xc].sum(axis=0)
...
#    flatfile="/home/ccd/FP_utils/sky_flat.dat")
    ...
    pl.legend(bbox_to_anchor=(0., 1.02, 1., .102),
